...
#'  \item{\code{distance}}{the Mahalanobis distance (function \code{cndMahalanobis}) is then calculated, using the reference's norm, for the reference's data and on a new data set in the analysis. The distance was proposed by Parent et al. (2009), as an improvement from Khiari (2001), to eliminate colinearity.}
