...
#' \cr \cr
#' The function \code{cndMethodRobustIrda} call a predefined method as a whole. New methods can also be built by assembling predefined cnd functions for each section. Those already defined are as follow.
#' \describe{
